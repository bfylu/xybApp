...
final class CheryHandler extends Handler {

    private static final String TAG = CheryHandler.class.getSimpleName();

    private final ScanPayFragment fragment;
    private final MultiFormatReader multiFormatReader;

    CheryHandler(ScanPayFragment fragment, Hashtable<DecodeHintType, Object> hints) {
    ...
    private void decode(byte[] data, int width, int height) {
        ...
        if (rawResult != null) {
            ...
            bundle.putParcelable(CheryThread.BARCODE_BITMAP, source.renderCroppedGreyscaleBitmap());
