...
public class DredgeProductActivity extends BaseActivity implements IActivity {
...
//        findViewById(R.id.include_title).setVisibility(View.GONE);
        ...
        myWebChromeClient.setWebCall(new MyWebChromeClient.WebCall() {
            ...
            public void fileChose(final ValueCallback<Uri> uploadMsg) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(DredgeProductActivity.this);
                ...
                try {
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
                        if (url.contains("jquery.js")) {
                            Log.i("result", url);
                            return new WebResourceResponse("application/x-javascript", "utf-8", DredgeProductActivity.this.getAssets().open("js/jquery.min.js"));
                        }
                        if (url.contains("iscroll.js")) {
                            Log.i("result", url);
                            return new WebResourceResponse("application/x-javascript", "utf-8", DredgeProductActivity.this.getAssets().open("js/iscroll.js"));
                        }
                        if (url.contains("jquery-form.js")) {
                            Log.i("result", url);
                            return new WebResourceResponse("application/x-javascript", "utf-8", DredgeProductActivity.this.getAssets().open("js/jquery-form.js"));
                        }
...
//                wvContent.loadUrl(url + sessionToken);
                wvContent.loadUrl(ResourceConstants.getOpenProductURI() + "?sessionToken=" + sessionToken);
            }
        }
    }
