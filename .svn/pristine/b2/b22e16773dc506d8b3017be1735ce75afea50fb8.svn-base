...
public class DividerDecoration extends RecyclerView.ItemDecoration{
    ...
    private boolean mDrawHeaderpublic = false;
    ...
    public void setDrawHeaderpublic(boolean mDrawHeaderpublic) {
        this.mDrawHeaderpublic = mDrawHeaderpublic;
    }
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        if (position>=headerCount&&position<parent.getAdapter().getItemCount()-publicCount||mDrawHeaderpublic){
    ...
    public void onDrawOver(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        int orientation = 0;
        int headerCount = 0,publicCount = 0,dataCount;
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (position>=dataStartPosition&&position<dataEndPosition-1//数据项除了最后一项
                    ...
                    ||(!(position>=dataStartPosition&&position<dataEndPosition)&&mDrawHeaderpublic)//header&public且可绘制
                    ){
