...
public class ChildAllFragment extends BaseFragment implements IShopOrder, RecyclerArrayAdapter.OnLoadMoreListener
    ...
    public static ChildAllFragment getChildAllFragment(Enums.shopOrder transType) {
        ChildAllFragment fragment = new ChildAllFragment();
    ...
    protected void initView() {
        mPresenter = new ShopOrderPresenter(getActivity(), ChildAllFragment.this);
    ...
    public void closeOrder(BaseBean data) {
        if (StringUtil.equals("000000", data.getRespCode())) {
            ...
            mIntent = new Intent();
            mIntent.setAction("cn.payadd.majia.fragment.shoporder.ChildAllFragment");
    ...
    public void getOrderNum(OrderNumBean bean) {
        if (StringUtil.equals("000000", bean.getRespCode())) {
            ShopAllOrderFragment fragment = (ShopAllOrderFragment) getParentFragment();
            fragment.initTitleList(bean.getData().getPendingPaymentCount()
