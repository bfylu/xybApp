...
public class ChildWaitSendFragment extends BaseFragment implements IShopOrder, RecyclerArrayAdapter.OnLoadMoreListener
    ...
    public static ChildWaitSendFragment getChildWaitSendFragment(Enums.shopOrder transType) {
        ChildWaitSendFragment fragment = new ChildWaitSendFragment();
    ...
    protected void initView() {
        mPresenter = new ShopOrderPresenter(getActivity(), ChildWaitSendFragment.this);
