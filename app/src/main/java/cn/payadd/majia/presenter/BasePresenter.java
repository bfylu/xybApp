...
//                String plaintext = jsonObj.toString();
    ...
    protected  void sendUrl5ToServer(String url, String service, Map<String, String> data, final ICallback succCallback) {
        sendUrl5ToServer(url, service, data, false, succCallback, null, null);
    }

    protected  void sendUrl5ToServer(String url, String service, Map<String, String> data, final ICallback succCallback, final ICallback failCallback) {
        sendUrl5ToServer(url, service, data, false, succCallback, failCallback, null);
    }

    protected  void sendUrl5ToServer(String url, String service, Map<String, String> data, final ICallback succCallback, final ICallback failCallback, final ICallback excpCallback) {
        sendUrl5ToServer(url, service, data, false, succCallback, failCallback, excpCallback);
    }
     ...
     * @param excpCallback
     */
    protected void sendUrl5ToServer(String url, String service, Map<String, String> data, boolean encrypt, final ICallback succCallback, final ICallback failCallback, final ICallback excpCallback) {
        Gson gson = new Gson();
        if (pending) {
            return;
        }
...
//                        respMsg = msg;
                    if (msg.contains("=") && msg.contains("&")) {
                        map = StringUtil.separateAndURLDecode(msg);
                    } else {
                        Gson gson = new Gson();
                        Type type = new TypeToken<Map<String, Object>>() {}.getType();
                        map = gson.fromJson(msg, type);
                    }
                    String respCode = map.get("respCode");
                    String respDesc = map.get("respDesc");
