...
public class PasswordInputView extends android.support.v7.widget.AppCompatEditText {
	...
	private int passwordBackgroundColor = 0xff000000;
	...
	private void init(Context context, AttributeSet attr) {
		...
		try {
			...
			passwordBackgroundColor = ta.getColor(R.styleable.PasswordInputView_passwordBackgroundColor, passwordBackgroundColor);
		} catch (Exception e) {
	...
	protected void onDraw(Canvas canvas) {
		...
		borderPaint.setColor(passwordBackgroundColor);
