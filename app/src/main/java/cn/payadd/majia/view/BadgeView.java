...
public class BadgeView extends View{
     ...
     * @return BadgeView
     */
    public BadgeView setBadgeGravity(int gravity,int topMargin,int bottomMargin,int leftMargin,int rightMargin) {
        mGravity = gravity;
        FrameLayout.LayoutParams params = (FrameLayout.LayoutParams) getLayoutParams();
    ...
    public BadgeView setBadgeLayoutParams(int width, int height, int gravity) {
        ...
        params.height = dip2px(getContext(), height);
        setLayoutParams(params);
        setBadgeGravity(gravity,0,0,0,0);
        return this;
    }
