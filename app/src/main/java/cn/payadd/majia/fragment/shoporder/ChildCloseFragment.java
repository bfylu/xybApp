...
public class ChildCloseFragment extends BaseFragment implements IShopOrder, RecyclerArrayAdapter.OnLoadMoreListener
    ...
    public static ChildCloseFragment getChildCloseFragment(Enums.shopOrder transType) {
        ChildCloseFragment fragment = new ChildCloseFragment();
    ...
    protected void initView() {
        mPresenter = new ShopOrderPresenter(getActivity(), ChildCloseFragment.this);
        ...
        intentFilter.addAction("cn.payadd.majia.fragment.shoporder.ChildAllFragment");
    ...
    public class RefreshBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            if (mPresenter != null && StringUtil.equals("4", transType.getString())) {
                onRefresh();
            }
        }
    }
