...
public class ChildProtectionFragment extends BaseFragment implements IShopOrder, RecyclerArrayAdapter.OnLoadMoreListener
    ...
    public static ChildProtectionFragment getChildProtectionFragment(Enums.shopOrder transType) {
        ChildProtectionFragment fragment = new ChildProtectionFragment();
    ...
    protected void initView() {
        mPresenter = new ShopOrderPresenter(getActivity(), ChildProtectionFragment.this);
    ...
    protected void initData() {
        mPresenter.queryShopProtectionOrder(transType.getString(), pageIndex, row);
    }
