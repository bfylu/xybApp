...
public class FriendshipConversation extends Conversation {
    ...
    public String getAvatarUrl() {
        return lastMessage.getProfile().getFaceUrl();
    }
...
//        context.startActivity(intent);
    ...
    public String getLastMessageSummary() {
        ...
        switch (lastMessage.getType()){
            case TIM_FUTURE_FRIEND_PENDENCY_IN_TYPE://我收到的好友申请的未决消息
                return name + BaseApplication.getAppContext().getString(R.string.summary_friend_add);
            case TIM_FUTURE_FRIEND_PENDENCY_OUT_TYPE://我发出的好友申请的未决消息
                return BaseApplication.getAppContext().getString(R.string.summary_me) + BaseApplication.getAppContext().getString(R.string.summary_friend_add_me) + name;
            case TIM_FUTURE_FRIEND_DECIDE_TYPE://已决消息
                return BaseApplication.getAppContext().getString(R.string.summary_friend_added) + name;
            case TIM_FUTURE_FRIEND_RECOMMEND_TYPE://好友推荐
                return BaseApplication.getAppContext().getString(R.string.summary_friend_recommend) + name;
            default:
                return "";
        }
    }
    ...
    public String getName() {
        return BaseApplication.getAppContext().getString(R.string.conversation_system_friend);
