...
import cn.payadd.majia.entity.aistore.FileMessage;
import cn.payadd.majia.entity.aistore.ImageMessage;
import cn.payadd.majia.entity.aistore.Message;
import cn.payadd.majia.entity.aistore.MessageFactory;
import cn.payadd.majia.entity.aistore.TextMessage;
import cn.payadd.majia.entity.aistore.UGCMessage;
import cn.payadd.majia.entity.aistore.VideoMessage;
import cn.payadd.majia.entity.aistore.VoiceMessage;
import cn.payadd.majia.im.presentation.presenter.ChatPresenter;
...
import cn.payadd.majia.util.aistore.RecorderUtil;
import cn.payadd.majia.view.aistore.ChatInput;
import cn.payadd.majia.view.aistore.TemplateTitle;
import cn.payadd.majia.view.aistore.VoiceSendingView;
...
public class ChatActivity extends FragmentActivity implements ChatView {
    ...
    public static void navToChat(Context context, String identify, String chatContent, TIMConversationType type){
        Intent intent = new Intent(context, ChatActivity.class);
        intent.putExtra("identify", identify);
        intent.putExtra("type", type);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chatContent = getIntent().getStringExtra("chatContent");
        type = (TIMConversationType) getIntent().getSerializableExtra("type");
        presenter = new ChatPresenter(this, identify, type);
        input = (ChatInput) findViewById(R.id.input_panel);
        title = (TemplateTitle) findViewById(R.id.chat_title);
        input.setChatView(this);
        chatView = input.getChatView();
        etInput = input.getEditText();
        adapter = new ChatAdapter(this, R.layout.item_message, messageList, myIcon, userIcon);
    ...
    private void getIcon() {
        ...
        list.add(identify);
        TIMFriendshipManager.getInstance().getUsersProfile(list, new IMUGCUploadListener<List<TIMUserProfile>>() {
            @Override
            ...
            public void onSuccess(List<TIMUserProfile> timUserProfiles) {
                userIcon = timUserProfiles.get(0).getFaceUrl();
                adapter.setIcon(myIcon, userIcon);
                title.setTitleText(timUserProfiles.get(0).getNickName());
            }
        });
        ...
        TIMFriendshipManager.getInstance().getSelfProfile(new TIMValueCallBack<TIMUserProfile>() {
            ...
            public void onSuccess(TIMUserProfile timUserProfile) {
                myIcon = timUserProfile.getFaceUrl();
                adapter.setIcon(myIcon, userIcon);
            }
        });
    }
...
//        RefreshEvent.getInstance().onRefresh();
    ...
    public void sendPhoto() {
        ...
        if (intent_photo.resolveActivity(getPackageManager()) != null) {
            File tempFile = FileUtil2.getTempFile(FileUtil2.FileType.IMG);
            if (tempFile != null) {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == CAPTURE_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK && data != null) {
                showImagePreview(FileUtil2.getFilePath(this, data.getData()));
            }

        } else if (requestCode == FILE_CODE) {
            if (resultCode == RESULT_OK) {
                sendFile(FileUtil2.getFilePath(this, data.getData()));
            }
