...
public class ChatAdapter extends ArrayAdapter<Message> {
    ...
    private String myIcon, userIcon;
    private View view;
    ...
    public ChatAdapter(Context context, int resource, List<Message> objects, String myIcon, String userIcon) {
        super(context, resource, objects);
        resourceId = resource;
        this.myIcon = myIcon;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (position < getCount()){
            ImageLoader.getInstance().displayImage(myIcon, viewHolder.rightAvatar);
            ImageLoader.getInstance().displayImage(userIcon, viewHolder.leftAvatar);
    ...
    public void setIcon(String myIcon, String userIcon) {
        this.myIcon = myIcon;
        this.userIcon = userIcon;
