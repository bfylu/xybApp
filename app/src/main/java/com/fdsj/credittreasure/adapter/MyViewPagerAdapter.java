...
public class MyViewPagerAdapter extends PagerAdapter implements ViewPager.OnPageChangeListener {
    ...
    public MyViewPagerAdapter(FragmentManager fragmentManager, ViewPager viewPager, List<Fragment> fragments) {
    ...
    public void setFragments(ViewPager viewPager, List<Fragment> fragments) {
        this.fragments = fragments;
        this.viewPager = viewPager;
        this.viewPager.setAdapter(this);
        this.viewPager.setOnPageChangeListener(this);
