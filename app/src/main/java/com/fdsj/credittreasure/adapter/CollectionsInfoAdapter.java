...
public class CollectionsInfoAdapter extends RecyclerArrayAdapter<Gathering.Bean> {


    public CollectionsInfoAdapter(Context context) {
        super(context);
    }
    ...
    class MyViewHolder extends BaseViewHolder<Gathering.Bean> {
        ...
        public void setData(Gathering.Bean data) {
            ...
            tv_gather_type.setText(Enums.httpPayType.getNameString(data.getAcquireMethod()));
